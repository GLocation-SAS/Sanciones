import svgPaths from "./svg-f6zj47edoe";

function Description() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="description">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[28px] min-h-px min-w-px not-italic relative text-[#7e7e7e] text-[18px]">Las propiedades definen las variantes disponibles del selector y establecen las reglas para su uso consistente dentro del sistema. Permiten adaptar el componente a distintos contextos de interacción sin perder coherencia visual ni accesibilidad.</p>
    </div>
  );
}
    ...
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="description">
      <div className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[0] min-h-px min-w-px not-italic relative text-[#7e7e7e] text-[0px] text-[18px]">
        <p className="mb-[18px]">
          ...
          <span className="leading-[28px]">define el estado visual del selector. Incluye los estados por defecto, hover, activo, seleccionado y disabled, los cuales comunican retroalimentación al usuario durante la interacción.</span>
        </p>
        <p className="mb-[18px]">
        ...
        <p className="mb-[18px]">
          ...
          <span className="leading-[28px]">{` controla la visibilidad del icono derecho que indica el comportamiento desplegable.`}</span>
        </p>
        <p className="mb-[18px]">
          <span className="font-['Inter:Bold',sans-serif] font-bold leading-[28px] not-italic">Floating label:</span>
          <span className="leading-[28px]">{` activa o desactiva la etiqueta flotante del campo según la variante del selector.`}</span>
        </p>
        <p>
...
function Frame1() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Nunito:Medium',sans-serif] font-medium leading-[28px] relative shrink-0 text-[#0b0b0b] text-[18px] whitespace-nowrap">Selecciona una opción</p>
    </div>
  );
}
...
function Dropdowns() {
  return (
    <div className="h-[52px] relative rounded-[8px] shrink-0 w-full" data-name="Dropdowns">
      <div aria-hidden="true" className="absolute border-2 border-[#cecece] border-solid inset-0 pointer-events-none rounded-[8px]" />
...
function Frame3() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[11px] px-[4px] top-[-10px]">
      <p className="font-['Nunito:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[#0b0b0b] text-[12px] whitespace-nowrap">Titulo del selector</p>
    </div>
  );
}
...
function Dropdowns1() {
  return (
    <div className="h-[52px] relative rounded-[8px] shrink-0 w-full" data-name="Dropdowns">
      <div aria-hidden="true" className="absolute border-2 border-[#0b0b0b] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="flex flex-row items-center size-full">
...
function Dropdowns2() {
  return (
    <div className="h-[52px] relative rounded-[8px] shrink-0 w-full" data-name="Dropdowns">
      <div aria-hidden="true" className="absolute border-2 border-[#3f51b5] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[24px] py-[12px] relative size-full">
          <Frame13 />
          <div className="relative shrink-0 size-[24px]" data-name="chevron-down">
...
function Frame9() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[11px] px-[4px] top-[-10px]">
      <p className="font-['Nunito:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[#3f51b5] text-[12px] whitespace-nowrap">Titulo del selector</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-[85px]">
      <p className="flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[28px] min-h-px min-w-px relative text-[#0b0b0b] text-[18px]">Label</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-[85px]">
      <p className="flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[28px] min-h-px min-w-px relative text-[#0b0b0b] text-[18px]">Label 2</p>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-[85px]">
      <p className="flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[28px] min-h-px min-w-px relative text-[#0b0b0b] text-[18px]">Label 3</p>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-col items-start relative rounded-[12px] shadow-[0px_4px_5.6px_0px_rgba(11,11,11,0.14)] shrink-0 w-full">
                  ...
                  <div className="h-[5px] relative w-[10px]" data-name="Icon">
                    <div className="absolute inset-[-20%_-10%]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 7">
                        <path d="M1 6L6 1L11 6" id="Icon" stroke="var(--stroke-0, #0B0B0B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                      </svg>
                    </div>
                  </div>
                </div>
...
function Frame22() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-[180px]">
      <p className="flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[28px] min-h-px min-w-px relative text-[#0b0b0b] text-[18px]">Label</p>
    </div>
  );
}
...
function Divider() {
  return (
    <div className="h-[20px] relative shrink-0 w-[2px]" data-name="Divider">
      <div className="-translate-y-1/2 absolute flex flex-col font-['Work_Sans:Medium',sans-serif] font-medium h-[16px] justify-center leading-[0] left-0 text-[#bdbdbd] text-[14px] top-[8px] w-[4px]">
...
function Frame23() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
      <div className="relative shrink-0 size-[24px]" data-name="x-02">
        <div className="absolute inset-1/4" data-name="Icon">
          <div className="absolute inset-[-8.33%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
              <path d="M13 1L1 13M13 13L1 1" id="Icon" stroke="var(--stroke-0, #3F51B5)" strokeLinecap="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
      </div>
...
function Frame27() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Nunito:Medium',sans-serif] font-medium leading-[28px] relative shrink-0 text-[#e1e1e1] text-[18px] whitespace-nowrap">Selecciona una opción</p>
    </div>
  );
}
...
function Dropdowns4() {
  return (
    <div className="bg-[#f6f6f6] h-[52px] relative rounded-[8px] shrink-0 w-full" data-name="Dropdowns">
      <div aria-hidden="true" className="absolute border-2 border-[#f6f6f6] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[24px] py-[12px] relative size-full">
          <Frame25 />
        </div>
...
function Frame28() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[11px] px-[4px] top-[-10px]">
      <p className="font-['Nunito:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[#f6f6f6] text-[12px] whitespace-nowrap">Titulo del selector</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[336px]">
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-[336px]" data-name="Dropdowns">
        <Dropdowns />
        <Frame3 />
      </div>
      ...
      <div className="content-stretch flex flex-col gap-[13px] h-[221px] items-start relative shrink-0 w-[336px]" data-name="Component 3">
        <Frame15 />
        <Frame16 />
      </div>
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-[336px]" data-name="Component 4">
        <Frame20 />
      </div>
...
function Frame33() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Nunito:Medium',sans-serif] font-medium leading-[28px] relative shrink-0 text-[#0b0b0b] text-[18px] whitespace-nowrap">Filtrar por mes</p>
    </div>
  );
}
...
function Frame34() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[11px] px-[4px] top-[-10px]">
      <p className="font-['Nunito:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[#0b0b0b] text-[12px] whitespace-nowrap">Filtro mes</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[235px]">
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-[235px]" data-name="Dropdowns">
        <Dropdowns5 />
        <Frame34 />
      </div>
    </div>
...
function Frame43() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-[85px]">
      <p className="flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[28px] min-h-px min-w-px relative text-[#0b0b0b] text-[18px]">Junio</p>
    </div>
  );
}
...
function Frame44() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-[85px]">
      <p className="flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[28px] min-h-px min-w-px relative text-[#0b0b0b] text-[18px]">Julio</p>
    </div>
  );
}
...
function Frame45() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-[85px]">
      <p className="flex-[1_0_0] font-['Nunito:Medium',sans-serif] font-medium leading-[28px] min-h-px min-w-px relative text-[#0b0b0b] text-[18px]">Agosto</p>
    </div>
  );
}
...
function Frame53() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0">
      <p className="font-['Nunito:Medium',sans-serif] font-medium leading-[28px] relative shrink-0 text-[#e1e1e1] text-[18px] whitespace-nowrap">Filtrar por mes</p>
    </div>
  );
}
...
function Frame54() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center left-[11px] px-[4px] top-[-10px]">
      <p className="font-['Nunito:Regular',sans-serif] font-normal leading-[18px] relative shrink-0 text-[#f6f6f6] text-[12px] whitespace-nowrap">Filtro mes</p>
    </div>
  );
}
...
function Frame29() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[235px]">
      ...
      <div className="content-stretch flex flex-col gap-[13px] h-[221px] items-start relative shrink-0 w-[235px]" data-name="Component 2">
        <Frame38 />
        <Frame42 />
      </div>
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-[235px]" data-name="Component 3">
        <Frame46 />
      </div>
...
function Dropdowns15() {
  return (
    <div className="h-[52px] relative rounded-[8px] shrink-0 w-full" data-name="Dropdowns">
      <div aria-hidden="true" className="absolute border-2 border-[#d93428] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[24px] py-[12px] relative size-full">
          <Frame85 />
          <Frame87 />
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[57px] h-[639px] items-start px-[64px] relative shrink-0 w-[1922px]">
      <Frame18 />
      <Frame29 />
      <Frame55 />
      <Frame66 />
